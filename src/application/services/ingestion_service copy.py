...
class IngestionService:
    ...
    def _save_to_neo4j(self, chunks: List[str], embeddings: List[List[float]], filename: str) -> str:
        ...
        try:
            ...
            MATCH (c1:Chunk {document_id: $document_id}), (c2:Chunk {document_id: $document_id})
            ...
            with self.driver.session() as session:
                ...
                if len(chunks_data) > 1:
                    ...
                    logger.info(f"Created {len(chunks_data) - 1} sequential relationships for document {document_id}.")
